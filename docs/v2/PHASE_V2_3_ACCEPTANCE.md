...
- 实现状态：完成，自动化验证通过。
- 人工验收：阶段 2 已由维护者验收通过；阶段 3 等待维护者人工验收。
- 阶段总体完成：未勾选。
...
- [ ] 我打开普通 Wiki，检查可视化、源码和最终预览。
- [ ] 我打开含代码、表格、图片和目录的 Wiki。
- [ ] 我打开含 `<NuxtLink>`、原始 HTML 或扩展语法的 Wiki。
- [ ] 我在三种模式间切换并保存，确认 Markdown 没有被破坏。
- [ ] 我确认最终预览视觉效果可以作为正式前台候选。
- [ ] 我确认 Comark 阻塞项已经清楚记录。
