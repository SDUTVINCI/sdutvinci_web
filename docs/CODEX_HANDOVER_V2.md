...
## 2026-08-20：匿名 Wiki 队内资料区

- 匿名 Wiki 首页新增独立“队内资料”区域。完全受限的 Wiki 按 `docKey` 合并为一张锁定卡；点击
  进入登录页，登录后回到该 Wiki。公开 Wiki 若混有受限页面，只增加“含需登录文章”标识。
- 匿名摘要只包含文档键、文档级标题、日期和登录后目标路径，不返回章节标题、章节数量、正文、
  Revision、哈希或搜索摘要。已登录列表继续返回完整目录，锁定区不再显示。
